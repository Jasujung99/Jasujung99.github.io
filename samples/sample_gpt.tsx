...
export default function HaeumHomePage() {
  return (
      ...
      <header className="p-6 shadow-sm bg-white sticky top-0 z-10">
        <div className="max-w-6xl mx-auto flex justify-between items-center">
          ...
          <nav className="space-x-6 text-sm">
            <a href="#about" className="hover:text-[#317873]">소개</a>
            <a href="#programs" className="hover:text-[#317873]">프로그램</a>
            <a href="#contact" className="hover:text-[#317873]">문의</a>
          </nav>
        </div>
      </header>
      ...
      <main className="px-4 md:px-8 max-w-6xl mx-auto">
        <section className="py-20 text-center">
          ...
          <p className="text-lg text-[#5b5b5b] max-w-2xl mx-auto">
            낭독, 토론, 소통을 통해 서로를 이해하고, 성찰하는 공간.<br/>
        ...
        <section id="contact" className="py-16">
          ...
          <div className="flex flex-col md:flex-row gap-4">
            ...
            <Button className="bg-[#317873] hover:bg-[#285f5b] text-white">소식 받기</Button>
          </div>
        </section>
